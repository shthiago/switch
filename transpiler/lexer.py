...
class SelectSparqlLexer():
    ...
    tokens = [
        ...
        *builtin_calls.values(),
        ...
        'VAR1', 'VAR2',
        # Symbols
        'SYMB_ASTERISK', 'SYMB_LP', 'SYMB_RP',
        'SYMB_LCB', 'SYMB_RCB', 'SYMB_LSB', 'SYMB_RSB',
        'SYMB_DOT', 'SYMB_COMMA', 'SYMB_SEMICOLON',
        'SYMB_a', 'SYMB_PIPE', 'SYMB_SLASH', 'SYMB_CIRCUMFLEX',
        'SYMB_QUESTION', 'SYMB_EXCLAMATION', 'SYMB_PLUS', 'SYMB_MINUS',
        'SYMB_OR', 'SYMB_AND', 'SYMB_C2',
        'SYMB_EQ', 'SYMB_NEQ', 'SYMB_GT',
        'SYMB_LT', 'SYMB_GTE', 'SYMB_LTE',
    ...
    PN_PREFIX = PN_CHARS_BASE + \
        r'(((' + PN_CHARS + r')|\.)*' + PN_CHARS + r')?'
    EXPONENT = r'[eE][+-]?[0-9]+'
    VARNAME = r'(' + PN_CHARS_U + r'|[0-9])+'

    PN_LOCAL = r'(' + PN_CHARS_U + r'|:|[0-9]|' + PLX + r')((' + PN_CHARS + \
        r'|\.|:|' + PLX + ')*(' + PN_CHARS + '|:|' + PLX + r'))?'
